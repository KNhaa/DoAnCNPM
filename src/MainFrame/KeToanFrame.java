...
public class KeToanFrame extends JFrame {
    ...
    JLabel lbhome, lbtinhluong, /*, lbkhuyenmai, lbdichvu, lbtkloaiphong, lbtkdichvu, lbtkluong, lbtkdoanhthu, lbphong,*/
            lbthoat, lbsetting,lbsetting_hid,lbabc, lbdangxuat, patt;
    JLabel hinhhome, hinhsp; 
    ...
    public void ShowBang() {
        ...
        lbhome.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                lbtinhluong.setForeground(color_font_no_hover);
        ...
        lbtinhluong = new JLabel("Tính lương");
        lbtinhluong.setForeground(color_font_no_hover);
        lbtinhluong.setBackground(color_background);
        lbtinhluong.setFont(new Font("Segoe UI", Font.BOLD, 20));
        lbtinhluong.setBounds(73, 125, 200, 40);
        lbtinhluong.setCursor(new Cursor(HAND_CURSOR));
        lbtinhluong.setOpaque(true);
        lbtinhluong.addMouseListener(new MouseListener() {
            // TÍNH LƯƠNG GUI
            @Override
            public void mouseClicked(MouseEvent e) {
                ...
                lbhome.setForeground(color_font_no_hover);
                lbtinhluong.setForeground(color_font_hover);
